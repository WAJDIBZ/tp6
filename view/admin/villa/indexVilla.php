...
<head>
 ...
 <link rel="stylesheet" href="../../view/admin/bootstrap.min.css">
</head>

<body>
<nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="indexVilla.php">KATANA Immobiliére</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../../../controller//admin//villa//addvilla.php">Add a villa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../../../controller//admin//villa//listervilla.php">villas List</a>
                </li>
                <li class="nav-item">
            ...
            <form class="d-flex" method="get" action="detailsVilla.php">
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
    ...
    <div class="container mt-3">
        <div class="text-center my-4">
            <h1 class="display-4" style="color: #ffffff; text-shadow: 2px 2px 4px #000000;">Liste des villas</h1>
        </div>
        <div class="row">
            <?php
